...
//仮保存されたファイル名で画像ファイルを習得（サーバーへ仮アップロードされたディレクトリとファイル名）
...
<body>
    ...
    <main>
        <div class="confirm">
            <h2>会員登録 確認</h2>
            <p class="p1">こちらの内容で登録しても宜しいでしょうか？</p>
        
            <p>氏名：<?php echo $_POST['name']; ?>
            </p>
            <p>メール：<?php echo $_POST['mail']; ?>
            </p>
            ...
            <div class="buttons">
                <div class="syusei">
                    <form action="register.php">
                        <input type="submit" class="syusei_button" size="35" value="戻って修正する" />
                    </form>
                </div>
